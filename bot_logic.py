...
async def on_message(message):
    ...
    if len(recent_drops) >= 5 and now - recent_drops[0] < 10:
        print(f"[{server_name}] [WARN] ⚠️ Quá nhiều drops, tạm bỏ qua...")
        return
    ...
    if image_url:
        ...
        try:
            ...
            if ocr_results:
                ...
                print(f"[{server_name}] ⚠️ [EMPTY] Quét xong nhưng không thấy số Print.")
